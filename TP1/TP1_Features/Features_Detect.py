...
if detector == 1:
    ...
    pS = 9
    eT = pS
    kp1 = cv2.ORB_create(nfeatures = nF,#250,#Par défaut : 500
                        scaleFactor = sF,#2,#Par défaut : 1.2
                        nlevels = nL,#3)#Par défaut : 8
                        edgeThreshold = eT,
                        patchSize = pS)
    kp2 = cv2.ORB_create(nfeatures = nF,#250,#Par défaut : 500
                        scaleFactor = sF,#2,#Par défaut : 1.2
                        nlevels = nL,#3)#Par défaut : 8
                        edgeThreshold = eT,
                        patchSize = pS)
